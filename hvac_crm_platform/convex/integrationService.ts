...
function extractServiceKeywords(content: string): string[] {
  const keywords = [
    'installation', 'maintenance', 'repair', 'service', 'emergency',
    'heating', 'cooling', 'ventilation', 'AC', 'air conditioning',
    'split', 'central', 'duct', 'filter', 'thermostat',
    'urgent', 'broken', 'not working', 'cold', 'hot', 'noise'
  ];
