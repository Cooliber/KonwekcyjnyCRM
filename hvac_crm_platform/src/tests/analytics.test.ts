...
describe("Advanced Analytics Dashboard", () => {
  describe("ROI Calculation Engine", () => {
    ...
    it("should calculate ROI correctly", () => {
      ...
      const _expectedROI = ((150000 - 24000) / 24000) * 100; // 525%
    ...
    it("should calculate profit margin correctly", () => {
      ...
      const _expectedMargin = ((150000 - 24000) / 150000) * 100; // 84%
    ...
    it("should handle edge cases in ROI calculation", () => {
      ...
      const roi =
        zeroOpCosts > 0 ? ((revenue - zeroOpCosts) / zeroOpCosts) * 100 : Number.POSITIVE_INFINITY;
      expect(roi).toBe(Number.POSITIVE_INFINITY);
  ...
  describe("Prophecy Accuracy Tracking", () => {
    ...
    it("should validate district accuracy rankings", () => {
      ...
      expect(mockProphecyData.districtAccuracy.Targówek).toBe(
  ...
  describe("District Efficiency Analysis", () => {
    ...
    it("should correlate efficiency with revenue", () => {
      ...
      const avgHighRevenue =
        highEfficiencyDistricts.reduce((sum, d) => sum + d.revenue, 0) /
        highEfficiencyDistricts.length;
      const avgLowRevenue =
        lowEfficiencyDistricts.reduce((sum, d) => sum + d.revenue, 0) /
        lowEfficiencyDistricts.length;
  ...
  describe("Performance Metrics Tracking", () => {
    ...
    it("should calculate overall system health", () => {
      ...
      const systemHealth =
        calculatedUptime >= 99.9
          ? "excellent"
          : calculatedUptime >= 99.0
            ? "good"
            : "needs_attention";
