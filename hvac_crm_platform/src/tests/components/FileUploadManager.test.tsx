...
describe("FileUploadManager", () => {
  ...
  it("categorizes files correctly", () => {
    ...
    const drawingFile = new File(["drawing content"], "blueprint-drawing.dwg", {
  ...
  it("shows upload progress correctly", async () => {
    ...
    vi.mocked(uploadFileWithProgress).mockImplementation(
      async (_bucket, _path, _file, onProgress) => {
  ...
  it("generates appropriate tags for Warsaw districts", () => {
    ...
    const srodmiescieFIle = new File(["content"], "śródmieście-hvac.pdf", {
