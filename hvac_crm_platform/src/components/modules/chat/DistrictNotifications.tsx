...
export const DistrictNotifications: React.FC<DistrictNotificationsProps> = ({
  district
}) => {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            ...
            <span className={`ml-2 px-2 py-1 text-xs rounded-full ${getAffluenceColor(districtInfo.affluence)}`}>
