      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600">Choose format and options for your report export</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              <label className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Export the raw data used in the report</div>
                </div>
              </label>
              ...
              {selectedFormat === 'pdf' && (
                <label className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">Include visualizations and charts in the PDF</div>
                  </div>
                </label>
              )}
              ...
              <label className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Set up automatic exports for this report</div>
                </div>
              </label>
            </div>
          </div>
          ...
          <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium text-purple-900 text-sm">Warsaw Intelligence Included</h4>
                <p className="text-sm text-purple-800 mt-1">
                  This export will include Warsaw-specific analytics such as district affluence scores, 
                  seasonal adjustments, and route optimization data.
                </p>
              </div>
            </div>
          </div>
