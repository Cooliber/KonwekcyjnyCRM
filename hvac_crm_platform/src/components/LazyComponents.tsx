...
function withLazyLoading<T extends React.ComponentType<any>>(
  ...
  return React.forwardRef<any, React.ComponentProps<T>>((props, ref) => (
    <ErrorBoundary level="component" fallback={<ErrorFallback componentName={componentName} />}>
...
export const LazyJobsModule = withLazyLoading(() => import("./modules/JobsModule"), "Jobs Module");
...
export const LazyMapModule = withLazyLoading(() => import("./modules/MapModule"), "Map Module");
...
export const LazyChatModule = withLazyLoading(() => import("./modules/ChatModule"), "Chat Module");
